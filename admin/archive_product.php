...
<body>
  ...
  <section id="container" class="">
    ...
    <!--sidebar end-->
    <?php $sql = query("SELECT * FROM tbl_products WHERE delete_product = '1' ");confirm($sql);?>
                ...
                <table class="table">
                  ...
                  <?php $no = 0; while($row = fetch_array($sql)):
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="btn-group">
                          <a class="btn btn-danger" title="Delete Product" href="delete/archive_product.php?delete=<?=$product_id?>"><i class="icon_close_alt2"></i></a>
                        </div>
                      </td>
                    </tr>
